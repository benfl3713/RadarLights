...
public record RGBLedMatrixOptions
{
    ...
    /// </summary>
    public int PwmBits { get; init; } = 11;
    ...
    /// </summary>
    public int PwmLsbNanoseconds { get; init; } = 130;

    /// <summary>
    /// The lower bits can be time-dithered for higher refresh rate.
    /// </summary>
    public int PwmDitherBits { get; init; } = 0;
    ...
    /// Scan mode.
    /// </summary>
    public ScanModes ScanMode { get; init; } = ScanModes.Progressive;
